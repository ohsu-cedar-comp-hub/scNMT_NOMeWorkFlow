...
#        expand("samples/trim/{sample}_R{replicate}_val_{replicate}_fastqc.zip", sample = SAMPLES, replicate=[1, 2]),
	...
	expand("bismarkSE/{sample}_R1.{sample}_merged_R1_val_1_bismark_bt2_SE_report.txt", sample = SAMPLES),
	expand("bismarkSE/{sample}_R2.{sample}_merged_R2_val_2_bismark_bt2_SE_report.txt", sample = SAMPLES),
